...
export MFLAGS="INREPO=yes LZ4=znlz4 NASM=znnasm XORRISO=znxorriso MCOPY=znmcopy MFORMAT=znmformat MMD=znmmd CPIO=zncpio FLEX=znflex BISON=znbison M4=znm4"
